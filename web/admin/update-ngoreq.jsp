                        ...
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">
                                    Update NGO Requirement Details</h4>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    %>
                                            ...
                                            <div class="m-t-20">
                                                <form class="" action="../updatengoreq" method="post">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <label>
                                                        Requirement Quantity</label>
                                                         <input type="text" class="form-control" name="ngoreq_qty" value="<%= rs.getString(2) %>" required placeholder="Enter Required Quantity" /></div>
