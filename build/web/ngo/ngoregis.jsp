                    ...
                    <div class="container">
                        <div class="row pt-30">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- Contact Form -->
                                <form id="contact_form" name="contact_form" class="" action="../ngosignup" method="post">
                                    <%
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label>NGO Name<small>*</small></label>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" class="form-control" required="" type="text" placeholder="Enter Address" rows="5">
                                                </textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="desc" class="form-control" required="" type="text" placeholder="Enter Description" rows="5">
                                                </textarea>
                                            </div>
                                        </div> 
