                        ...
                        <div class="row pt-30">
                            ...
                            <div class="col-md-12">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <%                                            ResultSet rs = DataManager.getData("SELECT O.order_id,O.date,O.status,M.ngo_name FROM order_master O INNER JOIN donor_master D ON (O.donor_id=D.`donor_id`) INNER JOIN ngo_master M ON (O.`ngo_id`=M.`ngo_id`)where D.`donor_id`=" + session.getAttribute("id"));
                                            while (rs.next()) {%>
                                        <tr>
                                            <td>
                                                <%= rs.getString(1)%> 
