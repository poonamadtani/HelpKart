...
public final class view_002dprocat_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(request.getParameter("did") != null){
        ...
        String rows = DataManager.setData("delete from product_cat where cat_id='" + did + "'");
        response.sendRedirect("view-procat.jsp?error=" + rows);
    }
      ...
      out.write("                                            Product Category Details</h3>\n");
      out.write("                                    </div>\n");
      ...
      out.write("                                         ");
                                    ...
                                    if (request.getParameter("error") != null) {
                                                            if (request.getParameter("error").equals("1")) {
                                                                out.println("<div class='alert alert-success'> Product Category Deleted Successfully </div>");
                                                            } else {
      ...
      out.write("                                                        ");
                                                            ...
                                                            ResultSet rs = DataManager.getData("Select * from product_cat");
                                                            while (rs.next()) { 
      out.write("\n");
      out.write("                                                        <tr>\n");
      out.write("                                                            <td>\n");
      ...
      out.write("                                                            </td>\n");
      out.write("                                                            <td>\n");
      out.write("                                                               <img src=\"../procatphotos//");
      out.print( rs.getString(4));
      out.write("\" height=\"100px\" width=\"100px\" />\n");
      out.write("                                                            </td>\n");
      out.write("                                                         \n");
      out.write("                                                            <td>\n");
      out.write("                                                              <a href=\"update-procat.jsp?eid=");
      out.print( rs.getString(1) );
