...
public final class update_002dngoreq_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (request.getParameter("eid") != null) {
        ...
        ResultSet rs = DataManager.getData("Select * from ngo_req where req_id=" + eid);
        if (rs.next()) {
      out.write(" \n");
      out.write("\n");
      ...
      out.write("                                    Update NGO Requirement Details</h4>\n");
      out.write("                               \n");
      ...
      out.write("                                              ");
                                    ...
                                    if (request.getParameter("error") != null) {
                                                            if (request.getParameter("error").equals("1")) {
                                                                out.println("<div class='alert alert-success'> NGO Requirements Updated Successfully </div>");
                                                            } else {
      ...
      out.write("                                                <form class=\"\" action=\"../updatengoreq\" method=\"post\">\n");
      out.write("                                                     <input type=\"hidden\" name=\"eid\" value=\"");
      out.print( eid );
      out.write("\"/>\n");
      out.write("                                                 <div class=\"form-group\">\n");
      out.write("                                                    <label>\n");
      out.write("                                                        Product Id</label>\n");
      out.write("                                                     <select  class=\"form-control\" name=\"product_id\" required>\n");
      ...
      out.write("                                                        ");
                                                            ...
                                                            while(rspro.next())
                                                            {
                                                                String result = (rspro.getString(1).equals(rs.getString(4))) ? "selected" : "";
                                                                out.println("<option value='" + rspro.getString(1) + "'" + result + ">" + rspro.getString(3) + "</option>");
                                                            }
      ...
      out.write("                                                 <div class=\"form-group\">\n");
      out.write("                                                            <label>\n");
      out.write("                                                                NGO Id</label>\n");
      out.write("                                                            <select  class=\"form-control\" name=\"ngo_id\" required>\n");
      out.write("                                                                <option>Select NGO</option>\n");
      out.write("                                                                ");
      ...
      out.write("                                                     <div class=\"form-group\">\n");
      out.write("                                                    <label>\n");
      out.write("                                                        Requirement Quantity</label>\n");
      out.write("                                                         <input type=\"text\" class=\"form-control\" name=\"ngoreq_qty\" value=\"");
      out.print( rs.getString(2) );
      out.write("\" required placeholder=\"Enter Required Quantity\" /></div>\n");
      out.write("                                                         \n");
      out.write("                                                    <div class=\"form-group\">\n");
      out.write("                                                    <div>\n");
      ...
      out.write("\n");
            ...
            response.sendRedirect("view-ngoreq.jsp");
        }
    } else {
        response.sendRedirect("view-ngoreq.jsp");
    }
