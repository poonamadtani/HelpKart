        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-body">
                    ...
                    <h4 class="text-muted text-center m-t-0"><b>Change Password</b></h4>
                    <form class="form-horizontal m-t-20" action="../changepass" method="post">
                        <div class="form-group">
                            ...
                            %>
                            <div class="col-xs-12">
                                <input name="txtold" class="form-control" type="text" required="" placeholder="Current Password"></div>
                        </div>
                            <div class="form-group">
                            <div class="col-xs-12">
                                <input name="txtoldc" class="form-control" type="password" required="" placeholder="New Password"></div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input name="txtnew" class="form-control" type="password" required="" placeholder="Confirm New Password"></div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-primary w-md waves-effect waves-light" type="submit">Submit</button></div>
                        </div>
