                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            ...
                                            <div class="m-t-20">
                                                ...
                                                <div class="form-group">
                                                    <label>
                                                        Admin Name</label>
                                                    <input type="text" class="form-control" name="admin_name" required placeholder="Enter Your Name" /></div>
                                                    
                                                    <div class="form-group">
                                                    <label>
                                                        Email_id</label>
                                                    <input type="email" class="form-control" name="admin_email" required placeholder="Enter Email id" /></div>
                                                     <div class="form-group">
                                                    <label>
                                                        Password</label>
                                                    <input type="password" class="form-control" name="admin_pass" required placeholder="Enter Password" /></div>
