        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-body">
                    ...
                    <form class="form-horizontal m-t-20" action="../forgotpass" method="post">
                        <div class="form-group">
                            ...
                            %>
                            <div class="col-xs-12">
                                <input name="txtEmail" class="form-control" type="email" required="" placeholder="Enter Email"></div>
                        </div>
                       
                       
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-primary w-md waves-effect waves-light" type="submit">Send Mail</button></div>
                        </div>
                        <div class="form-group m-t-30 m-b-0">
                            
                            <div class="col-sm-12 text-right"><a href="admin_reg.jsp" class="text-muted">Create an account</a></div>
                        </div>
                    </form>
                </div>
            </div>
