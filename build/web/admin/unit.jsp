                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <%
                                                        if (request.getParameter("error") != null) {
                                                            if (request.getParameter("error").equals("1")) {
                                                                out.println("<div class='alert alert-success'> Unit Added Successfully </div>");
                                                            } else {
                                            ...
                                            <div class="m-t-20">
                                                <form class="" action="../addunit" method="post">
                                                 <div class="form-group">
                                                    <label>
                                                        Unit Type</label>
                                                     <input type="text" class="form-control" name="unit_type" required placeholder="Enter Unit Type" /></div>
