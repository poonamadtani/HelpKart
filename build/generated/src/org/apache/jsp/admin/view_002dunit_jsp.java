...
public final class view_002dunit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (request.getParameter("did") != null) {
        ...
        String rows = DataManager.setData("Delete from unit where unit_id='" + did + "'");

        response.sendRedirect("view-unit.jsp?error=" + rows);
      ...
      out.write("                                            Unit Details</h3>\n");
      out.write("                                    </div>\n");
      out.write("                                    <div class=\"panel-body\">\n");
      out.write("                                        ");
                                            if (request.getParameter("error") != null) {
                                                if (request.getParameter("error").equals("1")) {
                                                    out.println("<div class='alert alert-success'> Unit Deleted Successfully </div>");
                                                } else {
      ...
      out.write("                                                        ");
                                                            ...
                                                            ResultSet rs = DataManager.getData("Select * from unit");
                                                            while (rs.next()) { 
      out.write("\n");
      out.write("                                                        <tr>\n");
      out.write("                                                            <td>\n");
      ...
      out.write("                                                            \n");
      out.write("                                                            <td>\n");
      out.write("                                                              <a href=\"update-unit.jsp?eid=");
      out.print( rs.getString(1));
