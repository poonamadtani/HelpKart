...
<%
    ...
    if (request.getParameter("eid") != null) {
        ...
        ResultSet rs = DataManager.getData("Select * from feedback where feedback_id=" + eid );
        if(rs.next()) {%> 
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <%
                                                        if (request.getParameter("error") != null) {
                                                            if (request.getParameter("error").equals("1")) {
                                                                out.println("<div class='alert alert-success'> Feedback Updated Successfully </div>");
                                                            } else {
                                            ...
                                            <div class="m-t-20">
                                                <form class="" action="../updatefeedback" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="ngo_id" required> 
                                                                ...
                                                                <%
                                                                    ...
                                                                    while (rsngo.next()) {
                                                                        String result=(rsngo.getString(1).equals(rs.getString(4)))? "selected" : "";
                                                    ...
                                                    <label>
                                                        Date</label>
                                                         <input type="date" value="<%= rs.getString(2) %>" class="form-control" name="feed_date" required placeholder="Enter Order Date" /></div>
                                                        <div class="form-group">
                                                    <label>
                                                        Description</label><div>
                                                            <textarea value="<%= rs.getString(3) %>" required class="form-control" name="feed_desc" rows="5"></textarea></div>
                                                </div>
                                                    <div class="form-group">
                                                    <div>
