                ...
                <div class="col-md-8">
                    <div class="widget no-border m-0">
                        <ul class="list-inline pull-right flip sm-pull-none sm-text-center mt-5">
                            <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-white"></i> <a class="text-white" href="#">079-46589647</a> </li>
                    ...
                    <div class="widget no-border m-0">
                        <ul class="list-inline pull-right flip sm-pull-none sm-text-center mt-5">
                            ...
                            <li class="mt-sm-10 mb-sm-10">
                                ...
                                <a class="btn btn-default btn-flat btn-xs bg-light p-5 font-11 pl-10 pr-10 ajaxload-popup" href="ngologin.jsp">Sign In</a>
                            </li>
                            <li class="mt-sm-10 mb-sm-10">
                                <a class="btn btn-default btn-flat btn-xs bg-light p-5 font-11 pl-10 pr-10 ajaxload-popup" href="ngoregis.jsp">Join Us</a>
                            </li>
                            <%} else {%>
            ...
            <div class="container">
                <nav id="menuzord-right" class="menuzord green no-bg"><a class="menuzord-brand pull-left flip xs-pull-center mb-15" href="index-mp-layout1.html"><img src="../logo/logo-wide.jpg" style="height: 180px; width:200px" alt=""></a>
                    <ul class="menuzord-menu">
                        ...
                        <li><a href="ngorequirement.jsp">Add Requirements</a>
                        ...
                        <li><a href="view-order.jsp">View Order Placed </a></li>
