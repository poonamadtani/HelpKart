                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            <%
                                                        if (request.getParameter("error") != null) {
                                                            if (request.getParameter("error").equals("1")) {
                                                                out.println("<div class='alert alert-success'> Order Added Successfully </div>");
                                                            } else {
                                            ...
                                            <div class="m-t-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label>
                                                        Order Date</label>
                                                         <input type="date" class="form-control" name="order_date" required placeholder="Enter Order Date" /></div>
                                                         <div class="form-group">
                                                    <label>
                                                        Order Status</label>
                                                             <input type="text" class="form-control" name="order_status" required placeholder="Enter Order Status" /></div>
                                                    <div class="form-group">
                                                    <div>
